...
public:
    void init()
    {
        window().renderer().setDrawFunction([&](bg2e::render::CommandQueue* queue) {
            ...
            ++frameNumber;
            float r = (sin(frameNumber / 120.f) + 1.0f) / 2.0f;
            float g = (sin(frameNumber / 120.f + 3.141592653589793f) + 1.0f) / 2.0f;
            float b = (sin(frameNumber / 120.f + 1.570796326794897f) + 1.0f) / 2.0f;
