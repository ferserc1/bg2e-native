...
public:
    ...
    void initScene() override
    {
		...
		auto texture = new bg2e::base::Texture(assetsPath, "two_submeshes_inner_albedo.jpg");
        ...
        auto texture2 = new bg2e::base::Texture(assetsPath, "two_submeshes_outer_albedo.jpg");
...
protected:
	...
	void createPipeline()
	{
		...
		plFactory.addShader("submeshes/test.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		plFactory.addShader("submeshes/test.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
