...
void CubemapRenderer::initFrameResources(vulkan::DescriptorSetAllocator* frameAllocator)
{
...
void CubemapRenderer::updateImage(const std::filesystem::path& imagePath)
{
    if (_skyTexture.get())
    {
        _skyTexture->cleanup();
...
void CubemapRenderer::update(VkCommandBuffer commandBuffer, vulkan::FrameResources& frameResources)
{
