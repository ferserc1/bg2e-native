...
class BG2E_API RendererBasicForward {
public:
    ...
    inline void setPipeline(VkPipeline pipeline) { _pipeline = pipeline; }

    inline VkPipelineLayout pipelineLayout() const { return _pipelineLayout; }
    inline void setPipelineLayout(VkPipelineLayout pipelineLayout) { _pipelineLayout = pipelineLayout; }
