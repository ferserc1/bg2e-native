...
template void DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::applyModifier(geo::Modifier<geo::MeshP> * mod);
...
template std::string DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::submeshGroupName(uint32_t index) const;
template bool DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::submeshVisibility(uint32_t index) const;
template void DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::iterateMaterials(std::function<void(base::MaterialAttributes&)> cb);
template glm::mat4 DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::submeshTransform(uint32_t index) const;
template void DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::load(render::Engine * engine);
template void DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshP, render::vulkan::geo::MeshP>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::applyModifier(geo::Modifier<geo::MeshPN> * mod);
...
template std::string DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::submeshGroupName(uint32_t index) const;
template bool DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::submeshVisibility(uint32_t index) const;
template void DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::iterateMaterials(std::function<void(base::MaterialAttributes&)> cb);
template glm::mat4 DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::submeshTransform(uint32_t index) const;
template void DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::load(render::Engine * engine);
template void DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPN, render::vulkan::geo::MeshPN>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPC, render::vulkan::geo::MeshPC>::applyModifier(geo::Modifier<geo::MeshPC> * mod);
...
template void DrawableGeneric<geo::MeshPC, render::vulkan::geo::MeshPC>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPC, render::vulkan::geo::MeshPC>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPC, render::vulkan::geo::MeshPC>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPC, render::vulkan::geo::MeshPC>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPC, render::vulkan::geo::MeshPC>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::applyModifier(geo::Modifier<geo::MeshPU> * mod);
...
template void DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPU, render::vulkan::geo::MeshPU>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::applyModifier(geo::Modifier<geo::MeshPNU> * mod);
...
template void DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNU, render::vulkan::geo::MeshPNU>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::applyModifier(geo::Modifier<geo::MeshPNC> * mod);
...
template void DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNC, render::vulkan::geo::MeshPNC>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::applyModifier(geo::Modifier<geo::MeshPNUC> * mod);
...
template void DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNUC, render::vulkan::geo::MeshPNUC>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::applyModifier(geo::Modifier<geo::MeshPNUT> * mod);
...
template void DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNUT, render::vulkan::geo::MeshPNUT>::renderMaterial(uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::applyModifier(geo::Modifier<geo::MeshPNUUT> * mod);
...
template void DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::setSubmeshName(const std::string& name, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::setSubmeshGroupName(const std::string& groupName, uint32_t submeshIndex);
template void DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::setSubmeshVisibility(bool visible, uint32_t submeshIndex);
...
template void DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::reload();
...
template const std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::renderMaterial(uint32_t submeshIndex) const;
template std::shared_ptr<render::MaterialBase>& DrawableGeneric<geo::MeshPNUUT, render::vulkan::geo::MeshPNUUT>::renderMaterial(uint32_t submeshIndex);
